  ...
  return (
    <div className="relative pt-32 pb-24 px-6 max-w-4xl mx-auto">
      <div className="space-y-12">
        ...
        {/* Content */}
        <div className="prose prose-invert max-w-none space-y-8 text-silver/80">
          <h2 className="text-2xl font-bold text-white border-l-4 border-gold pl-4">1. Introduction</h2>
          <p>BW Advisory Solutions (ABN 11 892 244 979) respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and protect your data when you engage with our services.</p>

          <p>We operate in accordance with the <strong>Australian Privacy Act 1988 (Cth)</strong> and adopt the <strong>ANZPAA (Australia New Zealand Police Advisory Agencies) Responsible and Ethical Artificial Intelligence Framework</strong> to ensure responsible, transparent, and ethical handling of your information.</p>
          ...
          <p>BW Advisory Solutions uses artificial intelligence systems to streamline analysis and deliver insights faster. AI assists with initial data synthesis, pattern recognition, and documentation — enabling us to provide expert analysis more efficiently without compromising quality or accountability.</p>

          <p><strong>This approach allows you to benefit from both AI efficiency and human expertise.</strong> You receive analysis that is accelerated by technology but reviewed, validated, and approved by a human expert with 30 years of professional experience.</p>

          <h3 className="text-xl font-bold text-gold">Our Commitment to Responsible AI</h3>
          <p>We adopt the <strong>ANZPAA Responsible and Ethical Artificial Intelligence Framework</strong> as the basis for all AI use. This ensures our approach meets the highest standards for transparency, accountability, and human oversight — the same framework adopted by Australian and New Zealand police agencies and government bodies.</p>

          <p>Additionally, we review our AI practices and privacy safeguards <strong>quarterly</strong> to ensure alignment with evolving privacy laws, security standards, and emerging AI ethics frameworks.</p>

          <h3 className="text-xl font-bold text-gold">What You Get: Brad's Expertise & Accountability</h3>
          <p><strong>Every piece of work you receive is reviewed, validated, and delivered by Brad Warburton</strong> — principal advisor with 30 years in law enforcement command and operational transformation.</p>
          <p>You are not receiving raw AI output. You are receiving:</p>
          <ul className="space-y-2 list-disc list-inside">
          ...
          <p>Request a copy of your personal data. We will provide your data in a machine-readable format (CSV/JSON) within 14 days.</p>

          <h3 className="text-xl font-bold text-gold">Correct</h3>
          <p>Request corrections to inaccurate information. We will update your data and confirm the change.</p>

          <h3 className="text-xl font-bold text-gold">Delete</h3>
          <p>Request deletion of your data — simply reach out and we'll remove it, except where we're legally required to retain data (e.g., invoices for tax purposes).</p>

          <h3 className="text-xl font-bold text-gold">Lodge a Complaint</h3>
          <p>If you believe we've mishandled your data, you can lodge a complaint with the <strong>Office of the Australian Information Commissioner (OAIC)</strong> at www.oaic.gov.au.</p>
          ...
          <p>Your data may be stored or processed in the <strong>United States</strong>. These systems comply with Australian Privacy Act standards. However, you should be aware that:</p>
          <ul className="space-y-2 list-disc list-inside">
          ...
          <p>We may update this Privacy Policy from time to time. We will notify you of material changes via email or by prominently posting the new policy on our website. Your continued engagement indicates your acceptance of the updated policy.</p>
